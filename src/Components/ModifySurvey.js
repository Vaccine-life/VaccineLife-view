...
const ModifySurvey = ({ setStatus, inputs, setInputs, formik }) => {
          ...
          <UpperCheckbox>
            ...
            <Option>
              <input
                ...
                defaultChecked={user.afterEffect.includes("두통/관절통/근육통")}
              />
              <label
                htmlFor="두통관절통근육통"
                style={{ fontSize: `${theme.bodyTwoSize}` }}
          ...
          <TwoOptions>
            ...
            <Option>
              <input
                ...
                defaultChecked={user.afterEffect.includes("접종부위 부기/발적")}
              />
              <label
                htmlFor="접종부위부기발적"
                style={{ fontSize: `${theme.bodyTwoSize}` }}
